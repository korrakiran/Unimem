"""Migration module to safely upgrade older schema versions of state.json to v2.0.0."""
...
def migrate_state(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if migrated:
        logger.info("Project state successfully migrated to the latest v2.0.0 schema version.")
